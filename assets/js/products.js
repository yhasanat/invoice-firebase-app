/* -----------------------------------------
   products.js – إدارة الأصناف والمخزون الديناميكي (Firebase)
------------------------------------------*/
...
async function saveStockItem(){
  ...
  if(res.status === "success"){
    alert("تم تسجيل حركة المخزون في Firebase.");
  } else {
    queueStockUpdateForSync(payload);
    alert("تم حفظ حركة المخزون محلياً (أوفلاين). سيتم إرسالها إلى Firebase عند توفر الإنترنت.");
  }
